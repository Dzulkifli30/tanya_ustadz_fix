...
<body class="bg-white"> <!-- Tailwind CSS class for light and dark mode background -->
            ...
            @foreach ($posts as $items)
                <a href="{{ route('content.show', $items->id) }}">
                    <div class="flex flex-col items-start bg-white border border-black rounded-lg p-5">
                        <h5 class="mb-5 text-xl font-bold text-[#2254C5] overflow-hidden text-ellipsis whitespace-nowrap w-5/6">
                            {{$items->pertanyaan }}
                        </h5>
    ...
    <!-- <nav aria-label="Page navigation example">
            <ul class="flex justify-center mt-5">
                <li>
                    <a href="#"
                        class="flex items-center justify-center px-4 h-10 ms-0 leading-tight text-[#2254C5] bg-white border border-e-0 border-gray-300 rounded-s-lg hover:bg-gray-100 hover:text-gray-700">Previous</a>
                </li>
                <li>
                    <a href="#"
                        class="flex items-center justify-center px-4 h-10 text-white border border-gray-300 bg-[#2254C5] hover:bg-blue-900">1</a>
                </li>
                <li>
                    <a href="#"
                        class="flex items-center justify-center px-4 h-10 leading-tight text-[#2254C5] bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 ">2</a>
                </li>
                <li>
                    <a href="#" aria-current="page"
                        class="flex items-center justify-center px-4 h-10 leading-tight text-[#2254C5] bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700">3</a>
                </li>
                <li>
                    <a href="#"
                        class="flex items-center justify-center px-4 h-10 leading-tight text-[#2254C5] bg-white border border-gray-300 rounded-e-lg hover:bg-gray-100 hover:text-gray-700 ">Next</a>
                </li>
            </ul>
        </nav> -->
